...
class AttendancePriceExport implements FromCollection,WithHeadings
{
    protected $userid;
    protected $month;
    ...
    public function __construct($userid, $month, $start_date, $end_date)
    {
        $this->userid       = $userid;
        $this->month        = $month;
    ...
    public function headings(): array
    {
        return [
            ...
            'Checkout Time', 'Total Hours','Tier Price', 'Total'
        ];
    }
    ...
    public function collection()
    {
        ...
        if($role_login == Constant::ROLE_VENDOR) {
            ...
            'employee_position.price',
            DB::raw("CAST(employee_position.price AS DECIMAL(10,2)) * CAST(time_to_sec(timediff(attendance.clock_out, attendance.clock_in)) / 3600 AS DECIMAL(10,2)) as total"))
