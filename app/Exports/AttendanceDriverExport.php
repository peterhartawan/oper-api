...
class AttendanceDriverExport implements FromCollection,WithHeadings
{
    protected $userid;
    protected $month;
    ...
    {
        return [
            'Name','Link Photo','Checkin date','Checkout date','Checkin Time','Description', 
    ...
    public function collection()
    {
        ...
        if($role_login == Constant::ROLE_VENDOR) {
            $attendances = Attendance::select('users.name as name', 'attendance.image_url',
