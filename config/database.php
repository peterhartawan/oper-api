...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'b2c' => [
            'driver' => 'mysql',
            'host' => env('DB_HOST_B2C', '127.0.0.1'),
            'port' => env('DB_PORT_B2C', '3306'),
            'database' => env('DB_DATABASE_B2C', 'forge'),
            'username' => env('DB_USERNAME_B2C', 'forge'),
            'password' => env('DB_PASSWORD_B2C', ''),
            'unix_socket' => env('DB_SOCKET_B2C', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'prefix_indexes' => true,
