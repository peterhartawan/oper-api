...
CREATE TABLE IF NOT EXISTS `oper`.`order_tasks` (
  ...
  `updated_by` INT(11) NULL DEFAULT NULL,
  `status` TINYINT(1) NULL DEFAULT NULL,
  `inspector_otp` VARCHAR(45) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' NULL DEFAULT NULL,
  `submit_latitude` DECIMAL(10,0) NULL DEFAULT NULL,
  `submit_longitude` DECIMAL(10,0) NULL DEFAULT NULL,
  `inspector_idinspector` INT(11) NULL DEFAULT NULL,
